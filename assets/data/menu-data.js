  ...
  sections: [
    {
      ...
      photoPosition: "tr",
      items: [
        { name: "Chocolate Iced Donut", price: "2.39" },
        { name: "Blueberry Cake Donut", price: "2.39" },
        { name: "French Donut", price: "2.49" },
        { name: "Homecut Donut", price: "2.59" },
        { name: "Honey Dip Donut", price: "2.79" },
        { name: "Boston Creme Donut", price: "2.59" },
        { name: "Charleston Delight Donut", price: "2.79" },
        { name: "Maple Iced Ring Donut", price: "2.49" },
        { name: "Jelly Donut", price: "2.79" },
        { name: "Bavarian Donut", price: "2.59" },
        { name: "Sour Creme Donut", price: "2.29" },
        { name: "Powdered Donut", price: "2.29" },
        { name: "Donut Holes", price: "1.00" },
        { name: "Half Dozen Donuts", price: "11.99" },
        { name: "Dozen Donuts", price: "24.99" }
      ]
    },
    {
      id: "coffee",
